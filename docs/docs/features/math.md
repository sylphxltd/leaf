...
Math rendering is optimized for production:

- **Pre-rendered at build time** - HTML/CSS generated during SSG
- **No runtime JavaScript** - Math is already rendered in HTML
- **KaTeX library** - ~77KB gzip (only used during build, not shipped to browser)
- **Fast page loads** - No client-side math processing needed
