...
- **⚡ Fast Response** - <50ms search response (tested on M1 MacBook Pro, 16GB RAM)
...
- **🌙 Theme Aware** - Matches your site theme
- **💾 Offline Support** - Search works offline after initial page load
...
| **Offline Support** | ✅ Yes | ❌ No | ❌ No (needs server) |
