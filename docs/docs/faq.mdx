...
Leaf is a modern React-based documentation framework that achieves 100% feature parity with VitePress. It uses Bun for faster builds, TypeScript for type safety, and the React ecosystem for maximum flexibility.

### How is Leaf different from VitePress?

Leaf uses **React** instead of Vue, **Bun** instead of Node.js, and **Sylphx tools** (Zen, Silk) instead of Vue's runtime. Otherwise, it maintains the same markdown syntax, features, and developer experience as VitePress.
...
Yes, Leaf requires Bun runtime for optimal performance. Install it with:
...
::: tip Why Bun?
Bun provides faster package installation and script execution compared to Node.js.
:::

### Can I use npm or pnpm instead of Bun?

While Leaf is built for Bun, you can use npm/pnpm for installation. However, build times will be slower:
...
We're targeting v1.0 for Q2 2024 once:
- All core features are stable
- CLI tool is released
